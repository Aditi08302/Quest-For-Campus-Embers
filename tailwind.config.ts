	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'flip-in': {'0%': {transform: 'rotateY(90deg)', opacity: '0',},
							'100%': {transform: 'rotateY(0deg)', opacity: '1',}
							},
				'fly-away': {'0%': {transform: 'translate(0, 0) scale(1)', opacity: '1',},
  							 '100%': { transform: 'translate(-50px, -100px) scale(0.5) rotate(720deg)', opacity: '0',},
							}
			...
			animation: {
				...
				'crumble': 'crumble 1s ease-in-out forwards',
				'dust-fly': 'dust-fly 1.2s ease-out forwards'
			},
			fontFamily: {
			...
			'dust-fly': {
				...
				'100%': {
					transform: 'translate3d(calc(-50px + 100px * var(--tw-random)), -100px, 0) scale(0.3)',
					opacity: 0,
				},
			},
		}
